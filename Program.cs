...
namespace ConwayLife
{
    public class Program
    {
        ...
        public static CellStatus[,] SurviveDieOrBorn4(
            int totalRows,
            int totalColumns,
            CellStatus[,] currentStateOfField,
            Func<int, int, int, int, CellStatus[,], int> getNumberOfNeighbours)
        ...
        private static int GetNeighboursNumber4(int currentRowIndex, int currentColumnIndex, int totalRows, int totalColumns, CellStatus[,] currentStateOfField)
        {
            int neighbours = 0;
